<?php
/**
 * Since content plugin version 3.0.0 this metadata is generated in the content plugin itself
 * as the respective fields are not dependend on the metainfo plugin
 *
 * @deprecated since content plugin version 3.0.0
 */
if (rex_string::versionCompare(rex_plugin::get('structure', 'content')->getVersion(), '3.0.0-dev', '<')) {
